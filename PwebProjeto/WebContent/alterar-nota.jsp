		...
		<form class="form-horizontal" method="POST" action="controller.do">
			<fieldset>
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="alterarDescricaoNota">Descrição da Nota</label>
					<div class="col-md-4">
						<input id="descricaoNota" name="alterarDescricaoNota" type="text"
							placeholder="Digite a descrição da nota"
							class="form-control input-md" value="${param.descricao}"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4  control-label">Data</label>
					<div class="col-md-4 date">
						<div class="input-group input-append date" id="alterarDataNota">
							<input type="text" class="form-control" name="alterarDataNota" value="${param.data}"/>
				...
				<input type="hidden" name="op" value="alterarNota" />
