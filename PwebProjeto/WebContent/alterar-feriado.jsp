			...
			<fieldset>
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="tituloFeriado">Nome
						do Feriado</label>
					<div class="col-md-4">
						<input id="tituloFeriado" name="AlteraTituloFeriado" type="text"
							placeholder="Digite o nome do feriado"
							class="form-control input-md" value="${requestScope.feriado.getTitulo()}">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4 date">
						<div class="input-group input-append date" id="inicioFeriado">
							<input type="text" class="form-control" name="AlteraInicioFeriado" value="${requestScope.feriado.getInicioAlterar()}"/>
				...
				<div class="form-group">
					...
					<div class="col-md-4 date">
						<div class="input-group input-append date" id="fimFeriado">
							<input type="text" class="form-control" name="AlteraFimFeriado" value="${requestScope.feriado.getFimAlterar() }"/> <span
				...
				<input type="hidden" name="op" value="alteraFeriado" />
				<input type="hidden" name="alteraIdFeriado" value="${ requestScope.feriado.getId()}" />
				<!-- Button -->
				<div class="form-group">
