...
<title>Cadastrar Feriado Substituto</title>
	...
	<div align="center">
		<form class="form-horizontal" method="POST" action="controller.do">
			<fieldset>
				...
				<!-- Form Name -->
				<legend>Adicionar Feriado Substituto</legend>

				<!-- Text input-->
				<div class="form-group">
					<label class="col-md-4 control-label" for="selectbasic">Selecione
						o feriado</label>
					<div class="col-md-4">
						<select id="selectbasic" name="feriadoSubstituto" class="form-control">


							<c:forEach var="item" items="${requestScope.feriadosFixos}">
				...
				<div class="form-group">
					...
					<div class="col-md-4 date">
						<div class="input-group input-append date" id="inicioFeriado">
							<input type="text" class="form-control" name="inicioFeriadoSubstituto" />
				...
				<div class="form-group">
					...
					<div class="col-md-4 date">
						<div class="input-group input-append date" id="fimFeriado">
							<input type="text" class="form-control" name="fimFeriadoSubstituto" /> <span
				...
				<input type="hidden" name="op" value="addFeriadoFixoSubstituto" />
				<!-- Button -->
				<div class="form-group">
